...
<html lang="en">
    <head>
        ...
        <title>SMKN 1 Solok Selatan</title>
		...
		<link rel="shortcut icon" href="assets/img/smkn1.jpg" type="image/x-icon">
		<link rel="icon" href="assets/img/smkn1.jpg" type="image/x-icon">
    </head>

    <body class="bg-gradient-info">
		<nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <a class="navbar-brand text-info" style="font-weight: 900;" href="login.php"> <img src="assets/img/smkn1.jpg" alt="" style="width:50px;height:35px;"> Sekolah Menengah Kejuruan Negeri 1 Solok Selatan</a>
            </div>
        </nav>
